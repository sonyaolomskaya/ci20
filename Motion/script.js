...
$("#seven").mouseleave(function(){
    $("#quote7").css("opacity", 0);
     $("#2020").css("opacity", 1);
})

$("#eight").mouseover(function(){
    $("#quote8").css("opacity", 1);
     $("#2020").css("opacity", 0);
})

$("#eight").mouseleave(function(){
    $("#quote8").css("opacity", 0);
     $("#2020").css("opacity", 1);
})

$("#nine").mouseover(function(){
    $("#quote9").css("opacity", 1);
     $("#2020").css("opacity", 0);
})

$("#nine").mouseleave(function(){
    $("#quote9").css("opacity", 0);
     $("#2020").css("opacity", 1);
})
