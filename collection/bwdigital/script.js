...
fetch("../data.json")
	...
	function buildPage(data) {
		...
		var SubFolderName = data.filter(function(entry){ return entry.SubFolderName == "Black&White"; });
		// entry.Location entry.FolderName
		console.log(SubFolderName);
		// //data is unaffected
		// var blues = data.filter(function(entry){ return entry.FolderName.includes.("Black&White")});
	}

// for (var i = 0; i = i + 1) {
// img = document.createElement("img")
// img.src = data[i].assets/hannah.jpg;
// }
